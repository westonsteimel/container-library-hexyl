...
version=`curl --silent "https://api.github.com/repos/sharkdp/hexyl/releases/latest" | jq .tag_name | xargs`
revision=`curl --silent "https://api.github.com/repos/sharkdp/hexyl/commits/${version}" | jq .sha | xargs`
version=${version#"v"}
